...
if __name__ == "__main__":
        ...
        .multi_agent(
            policies={
                "player_0": (None, obs_space, act_space, {
                    "exploration_config": {
                        "type": "EpsilonGreedy",
                        "initial_epsilon": 0.1,  # Set initial epsilon to 0.1 for exploration
                        "final_epsilon": 0.0,
    ...
    tune.run(
        ...
        checkpoint_freq=100,
        local_dir="/home/haoming/extreme_driving/Adeesh/RL/project/marl/results/" + env_name +"_baseline",
